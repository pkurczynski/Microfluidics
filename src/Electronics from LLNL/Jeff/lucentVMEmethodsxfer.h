...
const int MHVDAC_CRATES =   1;        // Maximum number of crates
const int MHVDAC_MODS  =   4;        // Maximum number of modules (boards)
const int MHVDAC_CHIPS =   36;         // Maximum number of chips (DACs / Board)
const int MHVDAC_DACS  =   8;         // Maximum number of dacs (channels / DAC)
...
const float BL_DACBits	= 8192.0;
//const float BL_DAC_VPB  =   BL_DACVolts/BL_DACBits;      // 13 bit DAC
const float BL_DAC_VPB  =   0.022;      // 13 bit DAC 
