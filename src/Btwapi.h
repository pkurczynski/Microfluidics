...
typedef enum {
    ...
    **
    **  See the SBS Bit 3 Hardware Manual and the PCI hardware specification
...
/*****************************************************************************
**
**  List all SBS Bit 3 adaptor IDs registered to date.
...
*/
/*BT_EXTERN bt_error_t __stdcall bt_gettrace(char * lpBuffer,
