...
// SetDAC()
//
// This routine has been modified to be consistent with code found in
// the computer used with UCB 4x288 channel drive electronics that were
// used at LLNL as part of CCIT phase I.
//
// plk 4/14/2004
...
bt_data16_t tdacdata;
    ...
    //    hw_status = BT_SUCCESS; // Until hardware is fixed
        ...
        // code from LLNL returns hw_status
        return(hw_status);
}
//---------------------------------------------------------------------------
