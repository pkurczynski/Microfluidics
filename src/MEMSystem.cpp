...
void MEMSystem::InitializeWireList(TTable *inWireListTable)
{
   ...
   while (!inWireListTable->Eof)
   {
        ...
        // wire list X,Y values were re-defined from -17...18 to eliminate
        // a "vacant" column and row corresponding to row=0 and column=0
        // on the grids defined in the large, hand drawn diagram of the
        // electrode array on green drafting paper.   plk 01/12/2004
